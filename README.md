...
5. Use node to run `src/data/getData.js` via `node src/data/getData.js` to download the data the app uses.
6. Use node to run `src/data/processJSON.js` via `node src/data/processJSON.js` to parse data for the app.
